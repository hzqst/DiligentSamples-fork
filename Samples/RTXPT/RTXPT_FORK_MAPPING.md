...
| `ProcessingPasses/PostProcess.h` | `src/RTXPTPostProcessPass.hpp` | P7, P8 | Future stable-plane/NRD post-process wrapper anchor; P4 only ports HDR test and LDR edge hooks. |
| `ProcessingPasses/PostProcess.cpp` | `src/RTXPTPostProcessPass.cpp` | P7, P8 | Future stable-plane merge, NRD prepare, and final-merge dispatch anchor; advanced variants stay disabled until prerequisites exist. |
| `ProcessingPasses/PostProcess.hlsl` | `assets/shaders/PostProcessing/RTXPTPostProcess.csh` | P7, P8 | Future `NoDenoiserFinalMerge`, NRD prepare, and final-merge shader anchor; P4 shader contains only HDR test and LDR edge paths. |
